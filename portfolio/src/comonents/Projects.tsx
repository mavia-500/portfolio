const Projects = () => {
  ...
  const projectsData: projectsData[] = [
    {
      title: "DineL HR Portal Website Development",
      description:
        "Built a modern and responsive HR Portal website for DineL, focusing on elegant UI design, smooth navigation",
      link: "https://dinel-web.vercel.app/",
      image: "/images/dinel.webp",
    },

    {
      title: "Asian Spices E-commerce Platform Development",
      description:
        "Designed and developed a visually rich and responsive Asian spices and recipes website",
      link: "https://asian-spices-web.vercel.app/",
      image: "/images/asainspices.webp",
    },
    {
      title: "IT Solutions Worldwide Website",
      description:
        "Contributed to the development of a scalable and user-focused corporate website for IT Solutions Worldwide",
    ...
    },
    {
      ...
      link: "https://www.hilyah.life/",
      image: "/images/Capture.webp",
    },
    ...
    //   description: "Make Potfolio Site in React",
    //   link: "hhtp//",
    //   image: "/images/wallet.PNG",
    // },
    {
      title: "Mine github",
      description:
        "Explore a variety of projects I've worked on — with source code available on GitHub",
  ...
  return (
    <div className="min-h-screen">
      ...
      <div
        id="projects"
        className="m-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6"
      >
